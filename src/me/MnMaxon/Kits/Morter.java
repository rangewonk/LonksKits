...
public class Morter extends Kit {
	public Morter() {
		super();
		guiType = Material.HOPPER;
	}
	...
	public ItemStack[] getInvContents() {
		...
		cont[1] = easyItem(ChatColor.BLUE + "Grenade Launcher", Material.HOPPER, 0, null, 1);
		cont = giveSoup(cont);
		return cont;
	}
	...
	public ItemStack[] getArmorContents() {
		...
		ItemStack helm = setColor(unbreak(easyItem(null, Material.TNT, 0, null, 1)), Color.BLUE);
		ItemStack chest = setColor(unbreak(easyItem(null, Material.DIAMOND_CHESTPLATE, 0, null, 1)), Color.BLUE);
		ItemStack pants = setColor(unbreak(easyItem(null, Material.GOLD_LEGGINGS, 0, null, 1)), Color.BLUE);
