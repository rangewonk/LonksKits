...
public class Blink extends Kit {
	public Blink() {
		super();
		guiType = Material.REDSTONE_TORCH_ON;
	}
	...
	public ItemStack[] getInvContents() {
		...
		cont[1] = easyItem(ChatColor.BLUE + "Blinker", Material.COAL, 0, null, 1);
		cont = giveSoup(cont);
		return cont;
	}
	...
	public ItemStack[] getArmorContents() {
		...
		ItemStack helm = setColor(unbreak(easyItem(null, Material.LEATHER_HELMET, 0, null, 1)), Color.RED);
